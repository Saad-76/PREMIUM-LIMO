...
import BasicInputBox from "@/components/basicTextField";
  ...
  return (
    <Container>
      <div className="container mx-auto">
        <h2 className="mb-2 mt-8 text-4xl tracking-tight font-extrabold text-center text-white">
          Contact Us
        </h2>

        <section className="relative z-10 overflow-hidden  pl-10 pr-10 lg:py-[60px]">
          <div className="container">
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div className="relative rounded-lg  p-8 shadow-lg bg-dark-2 sm:p-12">
                  <form>
                    <BasicInputBox
                      type="text"
                      name="name"
